...
class Numero extends UIComponent implements ComponentInterface{
    /**
     *
     * @var boolean Valeur
     */
	...
	parent::__construct($name, 'numero');
    }
    ...
    public function render(){
        $html = '<div id="line_'.$this->value.'" class="bold infobox floatLeft">'.$this->value.'</div>';
        return $html;
    }
